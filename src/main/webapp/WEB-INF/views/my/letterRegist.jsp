...
<form:form commandName="letter" class="form-horizontal"
	action="letterRegist" method="post">
	...
	<div class="input-group">
		<div class="input-append date form_startdate">
			<input size="16" type="text" placeholder="목표 시작일" readonly />
		...
		<div class="input-append date form_enddate">
			<input size="16" type="text" placeholder="목표 종료일" readonly />
			<span class="add-on"><i class="icon-th"></i></span>
		</div>
		<script type="text/javascript">
	...
	<div class="input-group">
		<label for="inputFiles">파일첨부</label> <input type="hidden"
			id="inputFiles">
		<form:hidden path="files" class="form-control"
